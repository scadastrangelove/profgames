...
**English starter layer:** [`en/`](https://scadastrangelove.github.io/profgames/en/) — AI-Mind full edition + A1 event explorer + fact-check audit layer + 30-slide presentation. The OSS/JITI side branch also has a full English package: [`en/oss/`](https://scadastrangelove.github.io/profgames/en/oss/).
...
| **OSS** | [На трёх слонах](https://scadastrangelove.github.io/profgames/oss/) / [On Three Elephants](https://scadastrangelove.github.io/profgames/en/oss/) | Боковая ветка цикла про AI, open source и JITI. Манифест о том, как дешевизна копирования, размытый провенанс и перенос принуждения на платформы меняют равновесие вокруг кода, посредников и ренты. К тексту приложен событийный слой из 110 сигналов по OSS, музыке, издательскому делу, data commons, праву, security disclosure и cloud/runtime. [HTML](https://scadastrangelove.github.io/profgames/oss/) · [EN](https://scadastrangelove.github.io/profgames/en/oss/) · [событийный слой](https://scadastrangelove.github.io/profgames/oss/ai_oss_events.html) · [EN events](https://scadastrangelove.github.io/profgames/en/oss/ai_oss_events.html) · [JSONL](https://github.com/scadastrangelove/profgames/blob/main/oss/ai_oss_signals.jsonl) · [EN JSONL](https://github.com/scadastrangelove/profgames/blob/main/en/oss/ai_oss_signals.jsonl) | ✅ опубликовано |
...
| **Z** | [Фактологическая основа](https://scadastrangelove.github.io/profgames/factcheck.html) | Независимый фактчек 68 утверждений с разнесением уровней доказательности. С первоисточниками, оговорками и рекомендованными формулировками. [HTML](https://scadastrangelove.github.io/profgames/factcheck.html) · [JSON](https://scadastrangelove.github.io/profgames/factcheck.json) | ✅ опубликовано |

## Машиночитаемая основа

Фактологическая база [`factcheck.json`](https://github.com/scadastrangelove/profgames/blob/main/factcheck.json) и событийный массив [`profgames_ai_signals.jsonl`](https://github.com/scadastrangelove/profgames/blob/main/profgames_ai_signals.jsonl) публикуются отдельно как самостоятельные артефакты. К ним добавлен параллельный психологический срез: Atlas [`aimind/atlas.json`](https://github.com/scadastrangelove/profgames/blob/main/aimind/atlas.json), методология [`aimind/aimind_methodology_pack.json`](https://github.com/scadastrangelove/profgames/blob/main/aimind/aimind_methodology_pack.json), psAIcho-методология [`aimind/psaicho_methodology.json`](https://github.com/scadastrangelove/profgames/blob/main/aimind/psaicho_methodology.json), массив сигналов [`aimind/aimind_signals.jsonl`](https://github.com/scadastrangelove/profgames/blob/main/aimind/aimind_signals.jsonl) и фактчек [`aimind/aimind_factcheck.json`](https://github.com/scadastrangelove/profgames/blob/main/aimind/aimind_factcheck.json) с общей шкалой доказательности и совместимой структурой полей. Отдельной боковой веткой опубликован OSS/JITI-слой: [`oss/ai_oss_signals.jsonl`](https://github.com/scadastrangelove/profgames/blob/main/oss/ai_oss_signals.jsonl), английская версия [`en/oss/ai_oss_signals.jsonl`](https://github.com/scadastrangelove/profgames/blob/main/en/oss/ai_oss_signals.jsonl), интерактивный каталог [`oss/ai_oss_events.html`](https://scadastrangelove.github.io/profgames/oss/ai_oss_events.html) и английский каталог [`en/oss/ai_oss_events.html`](https://scadastrangelove.github.io/profgames/en/oss/ai_oss_events.html). Все имена полей на английском, единая шкала статусов, ссылки на первоисточники.
...
claims[]          — 68 проверенных утверждений
...
JSONL: один сигнал на строку. 179 событий 2020–2026 с привязкой к рамке A.
...
summary           — краткое описание события
why               — почему это сигнал (привязка к рамке Y: PH01–PH15, V1–V8, E1–E5)
...
├── en/                                 # английский слой: AI-Mind, A1 explorer, factcheck, OSS/JITI, презентация
│   └── oss/                            #   английская статья OSS/JITI + английские JSON/HTML артефакты
...
│   ├── ai_oss_signals.jsonl            #   110 сигналов OSS/JITI
│   └── ai_oss_meta.json                #   методический и сводный слой
...
Тексты — Сергей Гордейчик, 2026. Машиночитаемые базы (`factcheck.json`, `profgames_ai_signals.jsonl`, `aimind/atlas.json`, `aimind/aimind_methodology_pack.json`, `aimind/psaicho_methodology.json`, `aimind/aimind_signals.jsonl`, `aimind/aimind_factcheck.json`, `oss/ai_oss_signals.jsonl`, `oss/ai_oss_meta.json`, `en/oss/ai_oss_signals.jsonl`, `en/oss/ai_oss_meta.json`) свободны для использования агентами и исследователями с указанием источника.
