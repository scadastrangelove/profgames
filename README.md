...
**English starter layer:** [`en/`](https://scadastrangelove.github.io/profgames/en/) — AI-Mind full edition + A1 event explorer + fact-check audit layer + 30-slide presentation.
...
| **OSS** | [На трёх слонах](https://scadastrangelove.github.io/profgames/oss/) | Боковая ветка цикла про AI, open source и JITI. Манифест о том, как дешевизна копирования, размытый провенанс и перенос принуждения на платформы меняют равновесие вокруг кода, посредников и ренты. К тексту приложен событийный слой из 110 сигналов по OSS, музыке, издательскому делу, data commons, праву, security disclosure и cloud/runtime. [HTML](https://scadastrangelove.github.io/profgames/oss/) · [событийный слой](https://scadastrangelove.github.io/profgames/oss/ai_oss_events.html) · [JSONL](https://github.com/scadastrangelove/profgames/blob/main/oss/ai_oss_signals.jsonl) | ✅ опубликовано |
