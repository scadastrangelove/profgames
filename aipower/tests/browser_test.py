...
def run(root,executable,only=None):
 ...
 with sync_playwright() as p:
  ...
  for lang,name in [('ru','ai-power-atlas-ru.html'),('en','ai-power-atlas.html')]:
   ...
   pg.evaluate("behaviorState.subdomain='all';behaviorState.mechanism='';renderBehaviorLayer(cyberRenderedEvents,cyberFocusEvents())")
   ...
   ok(lang+': all 119 governance drawers render',not errs)
