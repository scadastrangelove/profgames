...
| [`ai-power-atlas-ru.html`](ai-power-atlas-ru.html) | Self-contained Russian interactive atlas generated from the same v0.20 storygraph line. |
| [`ai_power_storygraph_en.json`](ai_power_storygraph_en.json) | Machine-readable English storygraph used by the atlas. |
| [`ai_power_storygraph_ru.json`](ai_power_storygraph_ru.json) | Russian v0.20 master storygraph with facts, claims, edges, sources and graph diagnostics. |
